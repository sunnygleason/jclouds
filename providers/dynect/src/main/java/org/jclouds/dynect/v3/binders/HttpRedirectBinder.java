...
public class HttpRedirectBinder implements Binder {
   ...
   @Override
   public <R extends HttpRequest> R bindToRequest(R request, Object httpRedirect) {
      HttpRedirect in = HttpRedirect.class.cast(checkNotNull(httpRedirect, "httpRedirect"));
