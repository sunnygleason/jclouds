 ...
 */
package org.jclouds.dynect.v3.domain.redirect;
...
public class HttpRedirect extends ForwardingMap<String, Object> {
   ...
   private HttpRedirect(String url, int code, String keepUri, String fqdn, String zone) {
      ...
      checkArgument(code == 301 || code == 302, "code must be 301 or 302 but was %s", code);
      this.code = code;
      checkNotNull(keepUri, "keepUri");
      checkArgument("Y".equalsIgnoreCase(keepUri) || "N".equalsIgnoreCase(keepUri), "keepUri must be 'Y' or 'N' but was %s", keepUri);
   ...
   public static final class Builder {
       ...
       */
      public HttpRedirect.Builder keepUri(String keepUri) {
